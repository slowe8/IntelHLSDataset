...
/* -------------------------------------------------------------------------- */
component void aes256_encrypt_ecb(aes256_context *ctx, hls_avalon_slave_memory_argument(32) hls_numbanks(16) hls_bankwidth(sizeof(uint8_t)) uint8_t *k, hls_avalon_slave_memory_argument(16) hls_numbanks(8) uint8_t *buf)
{
    //INIT
    uint8_t rcon = 1;
    uint8_t i;
