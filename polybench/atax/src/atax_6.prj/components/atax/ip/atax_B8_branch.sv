...
module atax_B8_branch (
    ...
    // out_c0_exe1185(GPOUT,9)
    assign out_c0_exe1185 = in_c0_exe1185;

    // out_c0_exe21712(GPOUT,10)
    assign out_c0_exe21712 = in_c0_exe21712;

    // out_c0_exe71766(GPOUT,11)
    assign out_c0_exe71766 = in_c0_exe71766;

    // out_c0_exe81777(GPOUT,12)
    assign out_c0_exe81777 = in_c0_exe81777;
