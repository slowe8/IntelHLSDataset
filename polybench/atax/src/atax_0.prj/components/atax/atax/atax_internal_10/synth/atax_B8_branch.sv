...
module atax_B8_branch (
    ...
    // out_c0_exe1173(GPOUT,9)
    assign out_c0_exe1173 = in_c0_exe1173;

    // out_c0_exe21592(GPOUT,10)
    assign out_c0_exe21592 = in_c0_exe21592;

    // out_c0_exe71646(GPOUT,11)
    assign out_c0_exe71646 = in_c0_exe71646;

    // out_c0_exe81657(GPOUT,12)
    assign out_c0_exe81657 = in_c0_exe81657;

    // out_memdep_phi_pop20(GPOUT,13)
