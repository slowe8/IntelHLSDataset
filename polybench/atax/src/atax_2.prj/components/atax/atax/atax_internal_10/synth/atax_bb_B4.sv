...
module atax_bb_B4 (
    ...
    wire [0:0] atax_B4_merge_out_forked62;
    wire [63:0] atax_B4_merge_out_idxprom100;
    wire [0:0] atax_B4_merge_out_notcmp77101;
    wire [0:0] atax_B4_merge_out_stall_out_0;
    wire [0:0] atax_B4_merge_out_stall_out_1;
    wire [0:0] atax_B4_merge_out_valid_out;
    wire [0:0] bb_atax_B4_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going65_atax6_exiting_stall_out;
    wire [0:0] bb_atax_B4_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going65_atax6_exiting_valid_out;
    ...
    wire [15:0] bb_atax_B4_stall_region_out_memdep_1_atax_avm_byteenable;
    ...
    wire [127:0] bb_atax_B4_stall_region_out_memdep_1_atax_avm_writedata;
    ...
    atax_B4_merge theatax_B4_merge (
        ...
        .in_idxprom100_0(in_idxprom100_0),
        .in_idxprom100_1(in_idxprom100_1),
        .in_notcmp77101_0(in_notcmp77101_0),
        .in_notcmp77101_1(in_notcmp77101_1),
        .in_stall_in(bb_atax_B4_stall_region_out_stall_out),
        .in_valid_in_0(in_valid_in_0),
        .in_valid_in_1(in_valid_in_1),
        .out_forked62(atax_B4_merge_out_forked62),
        .out_idxprom100(atax_B4_merge_out_idxprom100),
        .out_notcmp77101(atax_B4_merge_out_notcmp77101),
    ...
    atax_bb_B4_stall_region thebb_atax_B4_stall_region (
        .in_flush(in_flush),
        .in_forked62(atax_B4_merge_out_forked62),
        .in_idxprom100(atax_B4_merge_out_idxprom100),
        ...
        .in_notcmp77101(atax_B4_merge_out_notcmp77101),
        ...
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going65_atax6_exiting_stall_out(bb_atax_B4_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going65_atax6_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going65_atax6_exiting_valid_out(bb_atax_B4_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going65_atax6_exiting_valid_out),
