...
# ----------------------------------------
# If main_dpi_controller is one of several IP cores in your
...
# ----------------------------------------
# ACDS 20.4 72 linux 2024.01.02.20:41:34
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "main_dpi_controller.main_dpi_controller"
}
...
append ELAB_OPTIONS [subst [main_dpi_controller::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [main_dpi_controller::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [main_dpi_controller::get_memory_files "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [main_dpi_controller::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [main_dpi_controller::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [main_dpi_controller::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
