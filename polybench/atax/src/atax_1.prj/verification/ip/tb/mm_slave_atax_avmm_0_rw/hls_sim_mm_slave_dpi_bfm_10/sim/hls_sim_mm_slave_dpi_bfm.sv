...
module hls_sim_mm_slave_dpi_bfm(
   ...
   input wire                                           avs_read;
   input wire [lindex(AV_ADDRESS_W):0]                  avs_address;
   input wire [lindex(AV_NUMSYMBOLS):0]                 avs_byteenable;
   input wire [lindex(AV_BURSTCOUNT_W):0]               avs_burstcount;
   input wire                                           avs_beginbursttransfer;
   input wire                                           avs_begintransfer;
   input wire [lindex(AV_SYMBOL_W * AV_NUMSYMBOLS):0]   avs_writedata;
   input wire                                           avs_arbiterlock;
   input wire                                           avs_lock;
   input wire                                           avs_debugaccess;
   ...
   altera_avalon_mm_slave_bfm
    ...
    begin    
          ...
          begin
            ...
            for (int i = 0; i < burst_size; i++) begin : GEN_RANDOM_BLOCK_NAME_R108
          ...
          begin
            ...
            for (int i = 0; i < burst_size; i++) begin : GEN_RANDOM_BLOCK_NAME_R109
    ...
    begin
      ...
      for (int i = 0; i < burst_size; i++) begin : GEN_RANDOM_BLOCK_NAME_R110
    ...
    begin 
      ...
      for (int i = 0; i < burst_size; i++) begin : GEN_RANDOM_BLOCK_NAME_R111
