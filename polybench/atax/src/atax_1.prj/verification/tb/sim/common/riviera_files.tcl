...
source [file join [file dirname [info script]] ./../../../ip/tb/dpic_atax/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sp_cstart/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/atax_ir_cfan/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/cat_done/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_atax_y_out/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/cat_cwfsw/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/atax_en_cfan/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../../components/atax/atax/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/mm_slave_atax_avmm_0_rw/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_atax_x/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/sso_atax_A/sim/common/riviera_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/tb/atax_cfan/sim/common/riviera_files.tcl]
