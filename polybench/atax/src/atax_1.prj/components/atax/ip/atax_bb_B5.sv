...
module atax_bb_B5 (
    ...
    wire [0:0] bb_atax_B5_stall_region_out_cmp;
    wire [31:0] bb_atax_B5_stall_region_out_intel_reserved_ffwd_5_0;
    ...
    atax_B5_branch theatax_B5_branch (
        .in_cmp(bb_atax_B5_stall_region_out_cmp),
    ...
    atax_bb_B5_stall_region thebb_atax_B5_stall_region (
        ...
        .out_cmp(bb_atax_B5_stall_region_out_cmp),
        .out_intel_reserved_ffwd_5_0(bb_atax_B5_stall_region_out_intel_reserved_ffwd_5_0),
    ...
    assign out_intel_reserved_ffwd_5_0 = bb_atax_B5_stall_region_out_intel_reserved_ffwd_5_0;
