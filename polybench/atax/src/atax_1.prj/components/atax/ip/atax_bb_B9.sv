...
module atax_bb_B9 (
    ...
    wire [0:0] atax_B9_merge_out_forked35;
    wire [0:0] atax_B9_merge_out_stall_out_0;
    wire [0:0] atax_B9_merge_out_stall_out_1;
    wire [0:0] atax_B9_merge_out_valid_out;
    wire [0:0] bb_atax_B9_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going38_atax6_exiting_stall_out;
    wire [0:0] bb_atax_B9_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going38_atax6_exiting_valid_out;
    wire [0:0] bb_atax_B9_stall_region_out_c0_exe296;
    ...
    wire [31:0] bb_atax_B9_stall_region_out_unnamed_atax22_atax_avm_address;
    wire [0:0] bb_atax_B9_stall_region_out_unnamed_atax22_atax_avm_burstcount;
    wire [3:0] bb_atax_B9_stall_region_out_unnamed_atax22_atax_avm_byteenable;
    wire [0:0] bb_atax_B9_stall_region_out_unnamed_atax22_atax_avm_enable;
    wire [0:0] bb_atax_B9_stall_region_out_unnamed_atax22_atax_avm_read;
    wire [0:0] bb_atax_B9_stall_region_out_unnamed_atax22_atax_avm_write;
    wire [31:0] bb_atax_B9_stall_region_out_unnamed_atax22_atax_avm_writedata;
    wire [31:0] bb_atax_B9_stall_region_out_unnamed_atax23_atax_avm_address;
    wire [0:0] bb_atax_B9_stall_region_out_unnamed_atax23_atax_avm_burstcount;
    wire [3:0] bb_atax_B9_stall_region_out_unnamed_atax23_atax_avm_byteenable;
    wire [0:0] bb_atax_B9_stall_region_out_unnamed_atax23_atax_avm_enable;
    wire [0:0] bb_atax_B9_stall_region_out_unnamed_atax23_atax_avm_read;
    wire [0:0] bb_atax_B9_stall_region_out_unnamed_atax23_atax_avm_write;
    wire [31:0] bb_atax_B9_stall_region_out_unnamed_atax23_atax_avm_writedata;
    wire [0:0] bb_atax_B9_stall_region_out_valid_out;


    // atax_B9_branch(BLACKBOX,2)
    atax_B9_branch theatax_B9_branch (
        .in_c0_exe296(bb_atax_B9_stall_region_out_c0_exe296),
    ...
    atax_B9_merge theatax_B9_merge (
        ...
        .out_forked35(atax_B9_merge_out_forked35),
    ...
    atax_bb_B9_stall_region thebb_atax_B9_stall_region (
        .in_flush(in_flush),
        .in_forked35(atax_B9_merge_out_forked35),
        ...
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going38_atax6_exiting_stall_out(bb_atax_B9_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going38_atax6_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going38_atax6_exiting_valid_out(bb_atax_B9_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going38_atax6_exiting_valid_out),
        .out_c0_exe296(bb_atax_B9_stall_region_out_c0_exe296),
        ...
        .out_unnamed_atax22_atax_avm_address(bb_atax_B9_stall_region_out_unnamed_atax22_atax_avm_address),
        .out_unnamed_atax22_atax_avm_burstcount(bb_atax_B9_stall_region_out_unnamed_atax22_atax_avm_burstcount),
        .out_unnamed_atax22_atax_avm_byteenable(bb_atax_B9_stall_region_out_unnamed_atax22_atax_avm_byteenable),
        .out_unnamed_atax22_atax_avm_enable(bb_atax_B9_stall_region_out_unnamed_atax22_atax_avm_enable),
        .out_unnamed_atax22_atax_avm_read(bb_atax_B9_stall_region_out_unnamed_atax22_atax_avm_read),
        .out_unnamed_atax22_atax_avm_write(bb_atax_B9_stall_region_out_unnamed_atax22_atax_avm_write),
        .out_unnamed_atax22_atax_avm_writedata(bb_atax_B9_stall_region_out_unnamed_atax22_atax_avm_writedata),
        .out_unnamed_atax23_atax_avm_address(bb_atax_B9_stall_region_out_unnamed_atax23_atax_avm_address),
        .out_unnamed_atax23_atax_avm_burstcount(bb_atax_B9_stall_region_out_unnamed_atax23_atax_avm_burstcount),
        .out_unnamed_atax23_atax_avm_byteenable(bb_atax_B9_stall_region_out_unnamed_atax23_atax_avm_byteenable),
        .out_unnamed_atax23_atax_avm_enable(bb_atax_B9_stall_region_out_unnamed_atax23_atax_avm_enable),
        .out_unnamed_atax23_atax_avm_read(bb_atax_B9_stall_region_out_unnamed_atax23_atax_avm_read),
        .out_unnamed_atax23_atax_avm_write(bb_atax_B9_stall_region_out_unnamed_atax23_atax_avm_write),
        .out_unnamed_atax23_atax_avm_writedata(bb_atax_B9_stall_region_out_unnamed_atax23_atax_avm_writedata),
    ...
    assign out_exiting_stall_out = bb_atax_B9_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going38_atax6_exiting_stall_out;

    // out_exiting_valid_out(GPOUT,27)
    assign out_exiting_valid_out = bb_atax_B9_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going38_atax6_exiting_valid_out;
    ...
    // out_unnamed_atax22_atax_avm_address(GPOUT,38)
    assign out_unnamed_atax22_atax_avm_address = bb_atax_B9_stall_region_out_unnamed_atax22_atax_avm_address;

    // out_unnamed_atax22_atax_avm_burstcount(GPOUT,39)
    assign out_unnamed_atax22_atax_avm_burstcount = bb_atax_B9_stall_region_out_unnamed_atax22_atax_avm_burstcount;

    // out_unnamed_atax22_atax_avm_byteenable(GPOUT,40)
    assign out_unnamed_atax22_atax_avm_byteenable = bb_atax_B9_stall_region_out_unnamed_atax22_atax_avm_byteenable;

    // out_unnamed_atax22_atax_avm_enable(GPOUT,41)
    assign out_unnamed_atax22_atax_avm_enable = bb_atax_B9_stall_region_out_unnamed_atax22_atax_avm_enable;

    // out_unnamed_atax22_atax_avm_read(GPOUT,42)
    assign out_unnamed_atax22_atax_avm_read = bb_atax_B9_stall_region_out_unnamed_atax22_atax_avm_read;

    // out_unnamed_atax22_atax_avm_write(GPOUT,43)
    assign out_unnamed_atax22_atax_avm_write = bb_atax_B9_stall_region_out_unnamed_atax22_atax_avm_write;

    // out_unnamed_atax22_atax_avm_writedata(GPOUT,44)
    assign out_unnamed_atax22_atax_avm_writedata = bb_atax_B9_stall_region_out_unnamed_atax22_atax_avm_writedata;

    // out_unnamed_atax23_atax_avm_address(GPOUT,45)
    assign out_unnamed_atax23_atax_avm_address = bb_atax_B9_stall_region_out_unnamed_atax23_atax_avm_address;

    // out_unnamed_atax23_atax_avm_burstcount(GPOUT,46)
    assign out_unnamed_atax23_atax_avm_burstcount = bb_atax_B9_stall_region_out_unnamed_atax23_atax_avm_burstcount;

    // out_unnamed_atax23_atax_avm_byteenable(GPOUT,47)
    assign out_unnamed_atax23_atax_avm_byteenable = bb_atax_B9_stall_region_out_unnamed_atax23_atax_avm_byteenable;

    // out_unnamed_atax23_atax_avm_enable(GPOUT,48)
    assign out_unnamed_atax23_atax_avm_enable = bb_atax_B9_stall_region_out_unnamed_atax23_atax_avm_enable;

    // out_unnamed_atax23_atax_avm_read(GPOUT,49)
    assign out_unnamed_atax23_atax_avm_read = bb_atax_B9_stall_region_out_unnamed_atax23_atax_avm_read;

    // out_unnamed_atax23_atax_avm_write(GPOUT,50)
    assign out_unnamed_atax23_atax_avm_write = bb_atax_B9_stall_region_out_unnamed_atax23_atax_avm_write;

    // out_unnamed_atax23_atax_avm_writedata(GPOUT,51)
    assign out_unnamed_atax23_atax_avm_writedata = bb_atax_B9_stall_region_out_unnamed_atax23_atax_avm_writedata;
