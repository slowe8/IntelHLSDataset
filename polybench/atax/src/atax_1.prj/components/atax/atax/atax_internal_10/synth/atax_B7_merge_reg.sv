...
module atax_B7_merge_reg (
    ...
    reg [31:0] atax_B7_merge_reg_data_reg_0_x_q;
    reg [31:0] atax_B7_merge_reg_data_reg_1_x_q;
    reg [0:0] atax_B7_merge_reg_data_reg_2_x_q;
    ...
    begin
        if (!resetn)
        begin
            atax_B7_merge_reg_data_reg_2_x_q <= $unsigned(1'b0);
        end
        else if (stall_in_not_or_atax_B7_merge_reg_valid_reg_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            atax_B7_merge_reg_data_reg_1_x_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (stall_in_not_or_atax_B7_merge_reg_valid_reg_q == 1'b1)
        begin
    ...
    begin
        if (!resetn)
        begin
            atax_B7_merge_reg_data_reg_0_x_q <= $unsigned(32'b00000000000000000000000000000000);
        end
        else if (stall_in_not_or_atax_B7_merge_reg_valid_reg_q == 1'b1)
        begin
            atax_B7_merge_reg_data_reg_0_x_q <= $unsigned(in_data_in_0_tpl);
        end
    end
