...
// SystemVerilog created from i_llvm_fpga_push_token_i1_wt_limpush_atax0
...
module atax_i_llvm_fpga_push_token_i1_wt_limpush_0 (
    ...
    wire [0:0] i_llvm_fpga_push_token_i1_wt_limpush_atax1_dir;
    wire i_llvm_fpga_push_token_i1_wt_limpush_atax1_dir_bitsignaltemp;
    ...
    wire [0:0] i_llvm_fpga_push_token_i1_wt_limpush_atax1_predicate;
    wire i_llvm_fpga_push_token_i1_wt_limpush_atax1_predicate_bitsignaltemp;
    ...
    wire [0:0] i_llvm_fpga_push_token_i1_wt_limpush_atax1_feedback_out;
    wire i_llvm_fpga_push_token_i1_wt_limpush_atax1_feedback_out_bitsignaltemp;
    wire [0:0] i_llvm_fpga_push_token_i1_wt_limpush_atax1_feedback_valid_out;
    wire i_llvm_fpga_push_token_i1_wt_limpush_atax1_feedback_valid_out_bitsignaltemp;
    ...
    wire [0:0] i_llvm_fpga_push_token_i1_wt_limpush_atax1_reg_out_data_out;
    wire [0:0] i_llvm_fpga_push_token_i1_wt_limpush_atax1_reg_out_stall_out;
    wire [0:0] i_llvm_fpga_push_token_i1_wt_limpush_atax1_reg_out_valid_out;
    ...
    // i_llvm_fpga_push_token_i1_wt_limpush_atax1_reg(BLACKBOX,9)@20000000
    // out out_data_out@20000001
    // out out_valid_out@20000001
    atax_i_llvm_fpga_push_token_i1_wt_limpush_1_reg thei_llvm_fpga_push_token_i1_wt_limpush_atax1_reg (
        .in_data_in(adapt_scalar_trunc4_q),
        .in_stall_in(in_stall_in),
        .in_valid_in(i_llvm_fpga_push_token_i1_wt_limpush_atax1_valid_out),
        .out_data_out(i_llvm_fpga_push_token_i1_wt_limpush_atax1_reg_out_data_out),
        .out_stall_out(i_llvm_fpga_push_token_i1_wt_limpush_atax1_reg_out_stall_out),
        .out_valid_out(i_llvm_fpga_push_token_i1_wt_limpush_atax1_reg_out_valid_out),
        .clock(clock),
        .resetn(resetn)
    );
    ...
    // i_llvm_fpga_push_token_i1_wt_limpush_atax1(EXTIFACE,8)
    assign i_llvm_fpga_push_token_i1_wt_limpush_atax1_data_in = element_extension2_q[0:0];
    assign i_llvm_fpga_push_token_i1_wt_limpush_atax1_dir = GND_q;
    assign i_llvm_fpga_push_token_i1_wt_limpush_atax1_feedback_stall_in = in_feedback_stall_in_0;
    assign i_llvm_fpga_push_token_i1_wt_limpush_atax1_predicate = GND_q;
    assign i_llvm_fpga_push_token_i1_wt_limpush_atax1_stall_in = i_llvm_fpga_push_token_i1_wt_limpush_atax1_reg_out_stall_out;
    ...
    assign i_llvm_fpga_push_token_i1_wt_limpush_atax1_dir_bitsignaltemp = i_llvm_fpga_push_token_i1_wt_limpush_atax1_dir[0];
    ...
    assign i_llvm_fpga_push_token_i1_wt_limpush_atax1_predicate_bitsignaltemp = i_llvm_fpga_push_token_i1_wt_limpush_atax1_predicate[0];
    ...
    assign i_llvm_fpga_push_token_i1_wt_limpush_atax1_feedback_out[0] = i_llvm_fpga_push_token_i1_wt_limpush_atax1_feedback_out_bitsignaltemp;
    assign i_llvm_fpga_push_token_i1_wt_limpush_atax1_feedback_valid_out[0] = i_llvm_fpga_push_token_i1_wt_limpush_atax1_feedback_valid_out_bitsignaltemp;
    ...
    acl_push #(
        ...
        .dir(i_llvm_fpga_push_token_i1_wt_limpush_atax1_dir_bitsignaltemp),
        .feedback_stall_in(i_llvm_fpga_push_token_i1_wt_limpush_atax1_feedback_stall_in_bitsignaltemp),
        .predicate(i_llvm_fpga_push_token_i1_wt_limpush_atax1_predicate_bitsignaltemp),
        ...
        .feedback_out(i_llvm_fpga_push_token_i1_wt_limpush_atax1_feedback_out_bitsignaltemp),
        .feedback_valid_out(i_llvm_fpga_push_token_i1_wt_limpush_atax1_feedback_valid_out_bitsignaltemp),
    ...
    assign out_feedback_out_0 = i_llvm_fpga_push_token_i1_wt_limpush_atax1_feedback_out;
    assign out_feedback_valid_out_0 = i_llvm_fpga_push_token_i1_wt_limpush_atax1_feedback_valid_out;
    ...
    assign out_data_out = i_llvm_fpga_push_token_i1_wt_limpush_atax1_reg_out_data_out;
    assign out_valid_out = i_llvm_fpga_push_token_i1_wt_limpush_atax1_reg_out_valid_out;
