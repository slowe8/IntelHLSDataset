...
module atax_i_sfc_logic_s_c0_in_for_body9_s_c0_enter12214_atax0 (
    ...
    wire [0:0] i_masked74_atax37_qi;
    reg [0:0] i_masked74_atax37_q;
    ...
    reg [0:0] redist1_sync_together69_aunroll_x_in_c0_eni3_1_tpl_2_q;
    reg [63:0] redist2_sync_together69_aunroll_x_in_c0_eni3_2_tpl_1_q;
    reg [0:0] redist3_sync_together69_aunroll_x_in_c0_eni3_3_tpl_1_q;
    reg [0:0] redist4_sync_together69_aunroll_x_in_i_valid_1_q;
    reg [63:0] redist5_i_arrayidx174_atax0_dupName_0_trunc_sel_x_b_1_q;
    reg [63:0] redist6_i_arrayidx13_1_atax0_dupName_0_trunc_sel_x_b_1_q;
    reg [0:0] redist7_i_llvm_fpga_pop_i1_notcmp7789_pop29_atax38_out_data_out_1_q;
    reg [0:0] redist8_i_llvm_fpga_pipeline_keep_going65_atax6_out_data_out_1_q;
    reg [0:0] redist9_i_llvm_fpga_pipeline_keep_going65_atax6_out_data_out_2_q;
    reg [0:0] redist10_i_first_cleanup_xor71_atax4_q_1_q;
    ...
    // enable_stall_connector_not_enable(LOGICAL,212)
    assign enable_stall_connector_not_enable_q = $unsigned(~ (in_enable));

    // redist4_sync_together69_aunroll_x_in_i_valid_1(DELAY,205)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist4_sync_together69_aunroll_x_in_i_valid_1_q <= '0;
        end
        else if (in_enable == 1'b1)
        begin
            redist4_sync_together69_aunroll_x_in_i_valid_1_q <= $unsigned(in_i_valid);
        end
    end
    ...
    // redist8_i_llvm_fpga_pipeline_keep_going65_atax6_out_data_out_1(DELAY,209)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist8_i_llvm_fpga_pipeline_keep_going65_atax6_out_data_out_1_q <= '0;
        end
        else if (in_enable == 1'b1)
        begin
            redist8_i_llvm_fpga_pipeline_keep_going65_atax6_out_data_out_1_q <= $unsigned(i_llvm_fpga_pipeline_keep_going65_atax6_out_data_out);
        end
    end
    ...
    atax_i_llvm_fpga_push_i2_cleanups68_push27_0 thei_llvm_fpga_push_i2_cleanups68_push27_atax34 (
        ...
        .in_keep_going65(redist8_i_llvm_fpga_pipeline_keep_going65_atax6_out_data_out_1_q),
        .in_stall_in(enable_stall_connector_not_enable_q),
        .in_valid_in(redist4_sync_together69_aunroll_x_in_i_valid_1_q),
        .out_data_out(),
    ...
    begin
        ...
        begin
            valid_fanout_reg0_q <= $unsigned(redist4_sync_together69_aunroll_x_in_i_valid_1_q);
        end
    end
    ...
    // redist3_sync_together69_aunroll_x_in_c0_eni3_3_tpl_1(DELAY,204)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist3_sync_together69_aunroll_x_in_c0_eni3_3_tpl_1_q <= '0;
        end
        else if (in_enable == 1'b1)
        begin
            redist3_sync_together69_aunroll_x_in_c0_eni3_3_tpl_1_q <= $unsigned(in_c0_eni3_3_tpl);
        end
    end
    ...
    atax_i_llvm_fpga_pop_i1_notcmp7789_pop29_0 thei_llvm_fpga_pop_i1_notcmp7789_pop29_atax38 (
        .in_data_in(redist3_sync_together69_aunroll_x_in_c0_eni3_3_tpl_1_q),
        .in_dir(redist0_sync_together69_aunroll_x_in_c0_eni3_1_tpl_1_q),
    ...
    // redist7_i_llvm_fpga_pop_i1_notcmp7789_pop29_atax38_out_data_out_1(DELAY,208)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist7_i_llvm_fpga_pop_i1_notcmp7789_pop29_atax38_out_data_out_1_q <= '0;
        end
        else if (in_enable == 1'b1)
        begin
            redist7_i_llvm_fpga_pop_i1_notcmp7789_pop29_atax38_out_data_out_1_q <= $unsigned(i_llvm_fpga_pop_i1_notcmp7789_pop29_atax38_out_data_out);
        end
    end

    // i_masked74_atax37(LOGICAL,75)@2 + 1
    assign i_masked74_atax37_qi = i_notcmp61_atax30_q & i_first_cleanup70_atax3_sel_x_b;
    dspba_delay_ver #( .width(1), .depth(1), .reset_kind("ASYNC"), .phase(0), .modulus(1), .reset_high(1'b0) )
    i_masked74_atax37_delay ( .xin(i_masked74_atax37_qi), .xout(i_masked74_atax37_q), .ena(in_enable[0]), .clk(clock), .aclr(resetn) );
    ...
    begin
        ...
        begin
            valid_fanout_reg3_q <= $unsigned(redist4_sync_together69_aunroll_x_in_i_valid_1_q);
        end
    end

    // valid_fanout_reg6(REG,178)@2 + 1
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
        ...
        begin
            valid_fanout_reg6_q <= $unsigned(redist4_sync_together69_aunroll_x_in_i_valid_1_q);
        end
    end
    ...
    // bgTrunc_i_inc_3_atax25_sel_x(BITSELECT,84)@3
    assign bgTrunc_i_inc_3_atax25_sel_x_b = i_inc_3_atax25_q[31:0];

    // i_llvm_fpga_push_i32_j_039_push26_atax26(BLACKBOX,72)@3
    ...
    atax_i_llvm_fpga_push_i32_j_039_push26_0 thei_llvm_fpga_push_i32_j_039_push26_atax26 (
        ...
        .in_keep_going65(redist9_i_llvm_fpga_pipeline_keep_going65_atax6_out_data_out_2_q),
        .in_stall_in(enable_stall_connector_not_enable_q),
    ...
    // redist1_sync_together69_aunroll_x_in_c0_eni3_1_tpl_2(DELAY,202)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist1_sync_together69_aunroll_x_in_c0_eni3_1_tpl_2_q <= '0;
        end
        else if (in_enable == 1'b1)
        begin
            redist1_sync_together69_aunroll_x_in_c0_eni3_1_tpl_2_q <= $unsigned(redist0_sync_together69_aunroll_x_in_c0_eni3_1_tpl_1_q);
        end
    end

    // i_llvm_fpga_pop_i32_j_039_pop26_atax10(BLACKBOX,65)@3
    // out out_feedback_stall_out_26@20000000
    atax_i_llvm_fpga_pop_i32_j_039_pop26_0 thei_llvm_fpga_pop_i32_j_039_pop26_atax10 (
        .in_data_in(c_i32_045_q),
        .in_dir(redist1_sync_together69_aunroll_x_in_c0_eni3_1_tpl_2_q),
    ...
    // i_arrayidx13_3_atax0_dupName_0_shift_join_x(BITJOIN,130)@3
    ...
    // redist2_sync_together69_aunroll_x_in_c0_eni3_2_tpl_1(DELAY,203)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist2_sync_together69_aunroll_x_in_c0_eni3_2_tpl_1_q <= '0;
        end
        else if (in_enable == 1'b1)
        begin
            redist2_sync_together69_aunroll_x_in_c0_eni3_2_tpl_1_q <= $unsigned(in_c0_eni3_2_tpl);
        end
    end
    ...
    atax_i_llvm_fpga_pop_i64_idxprom88_pop28_0 thei_llvm_fpga_pop_i64_idxprom88_pop28_atax12 (
        .in_data_in(redist2_sync_together69_aunroll_x_in_c0_eni3_2_tpl_1_q),
        .in_dir(redist0_sync_together69_aunroll_x_in_c0_eni3_1_tpl_1_q),
    ...
    // redist6_i_arrayidx13_1_atax0_dupName_0_trunc_sel_x_b_1(DELAY,207)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist6_i_arrayidx13_1_atax0_dupName_0_trunc_sel_x_b_1_q <= '0;
        end
        else if (in_enable == 1'b1)
        begin
            redist6_i_arrayidx13_1_atax0_dupName_0_trunc_sel_x_b_1_q <= $unsigned(i_arrayidx13_1_atax0_dupName_0_trunc_sel_x_b);
        end
    end

    // i_arrayidx13_3_atax0_dupName_0_add_x(ADD,128)@3
    assign i_arrayidx13_3_atax0_dupName_0_add_x_a = {1'b0, redist6_i_arrayidx13_1_atax0_dupName_0_trunc_sel_x_b_1_q};
    ...
    // i_arrayidx13_3_atax0_dupName_2_trunc_sel_x(BITSELECT,134)@3
    ...
    // i_inc_1_atax19(LOGICAL,48)@3
    assign i_inc_1_atax19_q = i_llvm_fpga_pop_i32_j_039_pop26_atax10_out_data_out | c_i32_247_q;

    // i_inc_1_atax19_vt_select_0_merged_bit_select(BITSELECT,199)@3
    ...
    // i_inc_1_atax19_vt_join(BITJOIN,50)@3
    ...
    // i_idxprom12_2_atax20_sel_x(BITSELECT,165)@3
    assign i_idxprom12_2_atax20_sel_x_b = {32'b00000000000000000000000000000000, i_inc_1_atax19_vt_join_q[31:0]};

    // i_idxprom12_2_atax20_vt_select_0_merged_bit_select(BITSELECT,200)@3
    ...
    // i_idxprom12_2_atax20_vt_join(BITJOIN,36)@3
    ...
    // i_arrayidx13_2_atax0_dupName_0_narrow_x(BITSELECT,117)@3
    assign i_arrayidx13_2_atax0_dupName_0_narrow_x_b = i_idxprom12_2_atax20_vt_join_q[61:0];

    // i_arrayidx13_2_atax0_dupName_0_shift_join_x(BITJOIN,118)@3
    ...
    // i_arrayidx13_2_atax0_dupName_0_add_x(ADD,116)@3
    assign i_arrayidx13_2_atax0_dupName_0_add_x_a = {1'b0, redist6_i_arrayidx13_1_atax0_dupName_0_trunc_sel_x_b_1_q};
    ...
    // i_arrayidx13_2_atax0_dupName_2_trunc_sel_x(BITSELECT,122)@3
    ...
    // i_arrayidx13_1_atax0_dupName_0_add_x(ADD,104)@3
    assign i_arrayidx13_1_atax0_dupName_0_add_x_a = {1'b0, redist6_i_arrayidx13_1_atax0_dupName_0_trunc_sel_x_b_1_q};
    ...
    // i_arrayidx13_1_atax0_dupName_2_trunc_sel_x(BITSELECT,110)@3
    assign i_arrayidx13_1_atax0_dupName_2_trunc_sel_x_b = i_arrayidx13_1_atax0_dupName_0_add_x_q[63:0];

    // i_idxprom12_atax11_sel_x(BITSELECT,167)@3
    ...
    // redist5_i_arrayidx174_atax0_dupName_0_trunc_sel_x_b_1(DELAY,206)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist5_i_arrayidx174_atax0_dupName_0_trunc_sel_x_b_1_q <= '0;
        end
        else if (in_enable == 1'b1)
        begin
            redist5_i_arrayidx174_atax0_dupName_0_trunc_sel_x_b_1_q <= $unsigned(i_arrayidx174_atax0_dupName_0_trunc_sel_x_b);
        end
    end

    // i_arrayidx174_atax0_dupName_0_add_x(ADD,152)@3
    assign i_arrayidx174_atax0_dupName_0_add_x_a = {1'b0, redist5_i_arrayidx174_atax0_dupName_0_trunc_sel_x_b_1_q};
    ...
    // i_arrayidx174_atax0_dupName_2_trunc_sel_x(BITSELECT,158)@3
    assign i_arrayidx174_atax0_dupName_2_trunc_sel_x_b = i_arrayidx174_atax0_dupName_0_add_x_q[63:0];

    // i_arrayidx174_atax15_vt_select_63(BITSELECT,20)@3
    assign i_arrayidx174_atax15_vt_select_63_b = i_arrayidx174_atax0_dupName_2_trunc_sel_x_b[63:2];

    // i_arrayidx174_atax15_vt_join(BITJOIN,19)@3
    assign i_arrayidx174_atax15_vt_join_q = {i_arrayidx174_atax15_vt_select_63_b, i_arrayidx174_atax15_vt_const_1_q};

    // i_arrayidx13_atax0_dupName_0_add_x(ADD,140)@3
    assign i_arrayidx13_atax0_dupName_0_add_x_a = {1'b0, redist6_i_arrayidx13_1_atax0_dupName_0_trunc_sel_x_b_1_q};
    ...
    // i_arrayidx13_atax0_dupName_2_trunc_sel_x(BITSELECT,146)@3
    assign i_arrayidx13_atax0_dupName_2_trunc_sel_x_b = i_arrayidx13_atax0_dupName_0_add_x_q[63:0];

    // redist9_i_llvm_fpga_pipeline_keep_going65_atax6_out_data_out_2(DELAY,210)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist9_i_llvm_fpga_pipeline_keep_going65_atax6_out_data_out_2_q <= '0;
        end
        else if (in_enable == 1'b1)
        begin
            redist9_i_llvm_fpga_pipeline_keep_going65_atax6_out_data_out_2_q <= $unsigned(redist8_i_llvm_fpga_pipeline_keep_going65_atax6_out_data_out_1_q);
        end
    end

    // redist10_i_first_cleanup_xor71_atax4_q_1(DELAY,211)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist10_i_first_cleanup_xor71_atax4_q_1_q <= '0;
        end
        else if (in_enable == 1'b1)
        begin
            redist10_i_first_cleanup_xor71_atax4_q_1_q <= $unsigned(i_first_cleanup_xor71_atax4_q);
        end
    end

    // sync_out_aunroll_x(GPOUT,170)@3
    assign out_c0_exi9_0_tpl = GND_q;
    assign out_c0_exi9_1_tpl = redist10_i_first_cleanup_xor71_atax4_q_1_q;
    assign out_c0_exi9_2_tpl = redist9_i_llvm_fpga_pipeline_keep_going65_atax6_out_data_out_2_q;
    ...
    assign out_c0_exi9_9_tpl = redist7_i_llvm_fpga_pop_i1_notcmp7789_pop29_atax38_out_data_out_1_q;
