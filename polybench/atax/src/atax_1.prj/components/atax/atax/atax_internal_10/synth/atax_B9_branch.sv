...
module atax_B9_branch (
    ...
    // c0_exe296_cmp(LOGICAL,4)
    assign c0_exe296_cmp_q = ~ (in_c0_exe296);

    // valid_out_1_and(LOGICAL,21)
    assign valid_out_1_and_q = in_valid_in & c0_exe296_cmp_q;
    ...
    assign valid_out_0_and_q = in_valid_in & in_c0_exe296;
