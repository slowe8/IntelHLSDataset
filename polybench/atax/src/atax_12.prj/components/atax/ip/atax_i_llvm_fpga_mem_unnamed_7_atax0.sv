...
module atax_i_llvm_fpga_mem_unnamed_7_atax0 (
    ...
    wire [31:0] readdata_reg_unnamed_atax7_atax1_out_data_out;
    wire [0:0] readdata_reg_unnamed_atax7_atax1_out_stall_out;
    wire [0:0] readdata_reg_unnamed_atax7_atax1_out_valid_out;


    // readdata_reg_unnamed_atax7_atax1(BLACKBOX,12)@20000000
    // out out_data_out@20000001
    // out out_valid_out@20000001
    atax_readdata_reg_unnamed_7_atax1 thereaddata_reg_unnamed_atax7_atax1 (
        .in_data_in(i_llvm_fpga_mem_unnamed_atax7_atax1_o_readdata),
        .in_stall_in(in_i_stall),
        .in_valid_in(i_llvm_fpga_mem_unnamed_atax7_atax1_o_valid),
        .out_data_out(readdata_reg_unnamed_atax7_atax1_out_data_out),
        .out_stall_out(readdata_reg_unnamed_atax7_atax1_out_stall_out),
        .out_valid_out(readdata_reg_unnamed_atax7_atax1_out_valid_out),
        .clock(clock),
        .resetn(resetn)
    );
    ...
    // i_llvm_fpga_mem_unnamed_atax7_atax1(EXTIFACE,10)
    ...
    assign i_llvm_fpga_mem_unnamed_atax7_atax1_i_atomic_op = c_i3_09_q;
    assign i_llvm_fpga_mem_unnamed_atax7_atax1_i_bitwiseor = c_i64_02_q;
    assign i_llvm_fpga_mem_unnamed_atax7_atax1_i_byteenable = c_i4_05_q;
    assign i_llvm_fpga_mem_unnamed_atax7_atax1_i_cmpdata = c_i32_010_q;
    assign i_llvm_fpga_mem_unnamed_atax7_atax1_i_predicate = in_i_predicate;
    assign i_llvm_fpga_mem_unnamed_atax7_atax1_i_stall = readdata_reg_unnamed_atax7_atax1_out_stall_out;
    assign i_llvm_fpga_mem_unnamed_atax7_atax1_i_valid = in_i_valid;
    assign i_llvm_fpga_mem_unnamed_atax7_atax1_i_writedata = c_i32_010_q;
    assign i_llvm_fpga_mem_unnamed_atax7_atax1_stream_base_addr = c_i64_02_q;
    assign i_llvm_fpga_mem_unnamed_atax7_atax1_stream_reset = GND_q;
    assign i_llvm_fpga_mem_unnamed_atax7_atax1_stream_size = c_i32_010_q;
    ...
    assign out_o_readdata = readdata_reg_unnamed_atax7_atax1_out_data_out;
    assign out_o_valid = readdata_reg_unnamed_atax7_atax1_out_valid_out;
