...
// SystemVerilog created from atax_i_sfc_logic_s_c0_in_for_cond24_preh0000_c0_enter17112_atax0
...
module atax_i_sfc_logic_s_c0_in_for_cond24_preh0000_c0_enter17112_atax0 (
    ...
    output wire [0:0] out_c0_exi6178_0_tpl,
    output wire [63:0] out_c0_exi6178_1_tpl,
    output wire [63:0] out_c0_exi6178_2_tpl,
    output wire [31:0] out_c0_exi6178_3_tpl,
    output wire [0:0] out_c0_exi6178_4_tpl,
    output wire [0:0] out_c0_exi6178_5_tpl,
    output wire [0:0] out_c0_exi6178_6_tpl,
    ...
    wire [7:0] i_fpga_indvars_iv_next56_atax12_a;
    wire [7:0] i_fpga_indvars_iv_next56_atax12_b;
    logic [7:0] i_fpga_indvars_iv_next56_atax12_o;
    wire [7:0] i_fpga_indvars_iv_next56_atax12_q;
    ...
    wire [0:0] i_llvm_fpga_pipeline_keep_going95_atax2_out_exiting_stall_out;
    wire [0:0] i_llvm_fpga_pipeline_keep_going95_atax2_out_exiting_valid_out;
    wire [0:0] i_llvm_fpga_pipeline_keep_going95_atax2_out_not_exitcond_stall_out;
    wire [0:0] i_llvm_fpga_pipeline_keep_going95_atax2_out_pipeline_valid_out;
    ...
    wire [6:0] i_llvm_fpga_pop_i7_fpga_indvars_iv55_pop18_atax7_out_data_out;
    wire [0:0] i_llvm_fpga_pop_i7_fpga_indvars_iv55_pop18_atax7_out_feedback_stall_out_18;
    wire [0:0] i_llvm_fpga_push_i1_notexitcond96_atax11_out_feedback_out_9;
    wire [0:0] i_llvm_fpga_push_i1_notexitcond96_atax11_out_feedback_valid_out_9;
    ...
    wire [7:0] i_llvm_fpga_push_i7_fpga_indvars_iv55_push18_atax13_out_feedback_out_18;
    wire [0:0] i_llvm_fpga_push_i7_fpga_indvars_iv55_push18_atax13_out_feedback_valid_out_18;
    wire [0:0] i_notcmp93_atax10_q;
    wire [6:0] bgTrunc_i_fpga_indvars_iv_next56_atax12_sel_x_b;
    ...
    wire [0:0] i_exitcond57_atax8_cmp_nsign_q;
    reg [0:0] redist0_i_exitcond57_atax8_cmp_nsign_q_1_q;
    reg [0:0] redist1_i_exitcond57_atax8_cmp_nsign_q_6_q;
    reg [0:0] redist1_i_exitcond57_atax8_cmp_nsign_q_6_delay_0;
    reg [0:0] redist1_i_exitcond57_atax8_cmp_nsign_q_6_delay_1;
    reg [0:0] redist1_i_exitcond57_atax8_cmp_nsign_q_6_delay_2;
    reg [0:0] redist1_i_exitcond57_atax8_cmp_nsign_q_6_delay_3;
    ...
    reg [0:0] redist3_sync_together42_aunroll_x_in_c0_eni1170_1_tpl_1_q;
    reg [0:0] redist4_sync_together42_aunroll_x_in_c0_eni1170_1_tpl_6_q;
    reg [0:0] redist4_sync_together42_aunroll_x_in_c0_eni1170_1_tpl_6_delay_0;
    reg [0:0] redist4_sync_together42_aunroll_x_in_c0_eni1170_1_tpl_6_delay_1;
    reg [0:0] redist4_sync_together42_aunroll_x_in_c0_eni1170_1_tpl_6_delay_2;
    reg [0:0] redist4_sync_together42_aunroll_x_in_c0_eni1170_1_tpl_6_delay_3;
    ...
    // i_fpga_indvars_iv_next56_atax12(ADD,25)@1
    assign i_fpga_indvars_iv_next56_atax12_a = {1'b0, i_llvm_fpga_pop_i7_fpga_indvars_iv55_pop18_atax7_out_data_out};
    assign i_fpga_indvars_iv_next56_atax12_b = {1'b0, c_i7_128_q};
    assign i_fpga_indvars_iv_next56_atax12_o = $unsigned(i_fpga_indvars_iv_next56_atax12_a) + $unsigned(i_fpga_indvars_iv_next56_atax12_b);
    assign i_fpga_indvars_iv_next56_atax12_q = i_fpga_indvars_iv_next56_atax12_o[7:0];

    // bgTrunc_i_fpga_indvars_iv_next56_atax12_sel_x(BITSELECT,44)@1
    assign bgTrunc_i_fpga_indvars_iv_next56_atax12_sel_x_b = i_fpga_indvars_iv_next56_atax12_q[6:0];

    // i_llvm_fpga_push_i7_fpga_indvars_iv55_push18_atax13(BLACKBOX,37)@1
    // out out_feedback_out_18@20000000
    // out out_feedback_valid_out_18@20000000
    atax_i_llvm_fpga_push_i7_fpga_indvars_iv55_push18_0 thei_llvm_fpga_push_i7_fpga_indvars_iv55_push18_atax13 (
        .in_data_in(bgTrunc_i_fpga_indvars_iv_next56_atax12_sel_x_b),
        .in_exitcond57(i_exitcond57_atax8_cmp_nsign_q),
        .in_feedback_stall_in_18(i_llvm_fpga_pop_i7_fpga_indvars_iv55_pop18_atax7_out_feedback_stall_out_18),
        .in_stall_in(GND_q),
        .in_valid_in(in_i_valid),
        .out_data_out(),
        .out_feedback_out_18(i_llvm_fpga_push_i7_fpga_indvars_iv55_push18_atax13_out_feedback_out_18),
        .out_feedback_valid_out_18(i_llvm_fpga_push_i7_fpga_indvars_iv55_push18_atax13_out_feedback_valid_out_18),
        .out_stall_out(),
        .out_valid_out(),
        .clock(clock),
        .resetn(resetn)
    ...
    // i_llvm_fpga_pop_i7_fpga_indvars_iv55_pop18_atax7(BLACKBOX,34)@1
    // out out_feedback_stall_out_18@20000000
    atax_i_llvm_fpga_pop_i7_fpga_indvars_iv55_pop18_0 thei_llvm_fpga_pop_i7_fpga_indvars_iv55_pop18_atax7 (
        .in_data_in(c_i7_6226_q),
        .in_dir(in_c0_eni1170_1_tpl),
        .in_feedback_in_18(i_llvm_fpga_push_i7_fpga_indvars_iv55_push18_atax13_out_feedback_out_18),
        .in_feedback_valid_in_18(i_llvm_fpga_push_i7_fpga_indvars_iv55_push18_atax13_out_feedback_valid_out_18),
        .in_predicate(GND_q),
        .in_stall_in(GND_q),
        .in_valid_in(in_i_valid),
        .out_data_out(i_llvm_fpga_pop_i7_fpga_indvars_iv55_pop18_atax7_out_data_out),
        .out_feedback_stall_out_18(i_llvm_fpga_pop_i7_fpga_indvars_iv55_pop18_atax7_out_feedback_stall_out_18),
        .out_stall_out(),
        .out_valid_out(),
        .clock(clock),
        .resetn(resetn)
    ...
    // i_exitcond57_atax8_cmp_nsign(LOGICAL,65)@1
    assign i_exitcond57_atax8_cmp_nsign_q = $unsigned(~ (i_llvm_fpga_pop_i7_fpga_indvars_iv55_pop18_atax7_out_data_out[6:6]));

    // i_llvm_fpga_push_i1_notexitcond96_atax11(BLACKBOX,35)@1
    // out out_feedback_out_9@20000000
    // out out_feedback_valid_out_9@20000000
    atax_i_llvm_fpga_push_i1_notexitcond96_0 thei_llvm_fpga_push_i1_notexitcond96_atax11 (
        .in_data_in(i_exitcond57_atax8_cmp_nsign_q),
        .in_feedback_stall_in_9(i_llvm_fpga_pipeline_keep_going95_atax2_out_not_exitcond_stall_out),
        .in_stall_in(GND_q),
        .in_valid_in(in_i_valid),
        .out_data_out(),
        .out_feedback_out_9(i_llvm_fpga_push_i1_notexitcond96_atax11_out_feedback_out_9),
        .out_feedback_valid_out_9(i_llvm_fpga_push_i1_notexitcond96_atax11_out_feedback_valid_out_9),
        .out_stall_out(),
        .out_valid_out(),
        .clock(clock),
        .resetn(resetn)
    ...
    // i_llvm_fpga_pipeline_keep_going95_atax2(BLACKBOX,32)@1
    // out out_exiting_stall_out@20000000
    // out out_exiting_valid_out@20000000
    // out out_initeration_stall_out@20000000
    // out out_not_exitcond_stall_out@20000000
    // out out_pipeline_valid_out@20000000
    atax_i_llvm_fpga_pipeline_keep_going95_0 thei_llvm_fpga_pipeline_keep_going95_atax2 (
        .in_data_in(VCC_q),
        .in_initeration_in(GND_q),
        .in_initeration_valid_in(GND_q),
        .in_not_exitcond_in(i_llvm_fpga_push_i1_notexitcond96_atax11_out_feedback_out_9),
        .in_not_exitcond_valid_in(i_llvm_fpga_push_i1_notexitcond96_atax11_out_feedback_valid_out_9),
        .in_pipeline_stall_in(in_pipeline_stall_in),
        .in_stall_in(GND_q),
        .in_valid_in(in_i_valid),
        .out_data_out(),
        .out_exiting_stall_out(i_llvm_fpga_pipeline_keep_going95_atax2_out_exiting_stall_out),
        .out_exiting_valid_out(i_llvm_fpga_pipeline_keep_going95_atax2_out_exiting_valid_out),
        .out_initeration_stall_out(),
        .out_not_exitcond_stall_out(i_llvm_fpga_pipeline_keep_going95_atax2_out_not_exitcond_stall_out),
        .out_pipeline_valid_out(i_llvm_fpga_pipeline_keep_going95_atax2_out_pipeline_valid_out),
        .out_stall_out(),
        .out_valid_out(),
        .clock(clock),
        .resetn(resetn)
    ...
    assign out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going95_atax2_exiting_valid_out = i_llvm_fpga_pipeline_keep_going95_atax2_out_exiting_valid_out;
    assign out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going95_atax2_exiting_stall_out = i_llvm_fpga_pipeline_keep_going95_atax2_out_exiting_stall_out;

    // pipeline_valid_out_sync(GPOUT,41)
    assign out_pipeline_valid_out = i_llvm_fpga_pipeline_keep_going95_atax2_out_pipeline_valid_out;
    ...
    // redist0_i_exitcond57_atax8_cmp_nsign_q_1(DELAY,66)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist0_i_exitcond57_atax8_cmp_nsign_q_1_q <= '0;
        end
        else
        begin
            redist0_i_exitcond57_atax8_cmp_nsign_q_1_q <= $unsigned(i_exitcond57_atax8_cmp_nsign_q);
        end
    end
    ...
    atax_i_llvm_fpga_push_i32_i_138_push19_0 thei_llvm_fpga_push_i32_i_138_push19_atax15 (
        ...
        .in_exitcond57(redist0_i_exitcond57_atax8_cmp_nsign_q_1_q),
    ...
    // redist3_sync_together42_aunroll_x_in_c0_eni1170_1_tpl_1(DELAY,69)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist3_sync_together42_aunroll_x_in_c0_eni1170_1_tpl_1_q <= '0;
        end
        else
        begin
            redist3_sync_together42_aunroll_x_in_c0_eni1170_1_tpl_1_q <= $unsigned(in_c0_eni1170_1_tpl);
        end
    end
    ...
    atax_i_llvm_fpga_pop_i32_i_138_pop19_0 thei_llvm_fpga_pop_i32_i_138_pop19_atax3 (
        ...
        .in_dir(redist3_sync_together42_aunroll_x_in_c0_eni1170_1_tpl_1_q),
    ...
    // redist4_sync_together42_aunroll_x_in_c0_eni1170_1_tpl_6(DELAY,70)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist4_sync_together42_aunroll_x_in_c0_eni1170_1_tpl_6_delay_0 <= '0;
            redist4_sync_together42_aunroll_x_in_c0_eni1170_1_tpl_6_delay_1 <= '0;
            redist4_sync_together42_aunroll_x_in_c0_eni1170_1_tpl_6_delay_2 <= '0;
            redist4_sync_together42_aunroll_x_in_c0_eni1170_1_tpl_6_delay_3 <= '0;
            redist4_sync_together42_aunroll_x_in_c0_eni1170_1_tpl_6_q <= '0;
        end
        else
        begin
            redist4_sync_together42_aunroll_x_in_c0_eni1170_1_tpl_6_delay_0 <= $unsigned(redist3_sync_together42_aunroll_x_in_c0_eni1170_1_tpl_1_q);
            redist4_sync_together42_aunroll_x_in_c0_eni1170_1_tpl_6_delay_1 <= redist4_sync_together42_aunroll_x_in_c0_eni1170_1_tpl_6_delay_0;
            redist4_sync_together42_aunroll_x_in_c0_eni1170_1_tpl_6_delay_2 <= redist4_sync_together42_aunroll_x_in_c0_eni1170_1_tpl_6_delay_1;
            redist4_sync_together42_aunroll_x_in_c0_eni1170_1_tpl_6_delay_3 <= redist4_sync_together42_aunroll_x_in_c0_eni1170_1_tpl_6_delay_2;
            redist4_sync_together42_aunroll_x_in_c0_eni1170_1_tpl_6_q <= redist4_sync_together42_aunroll_x_in_c0_eni1170_1_tpl_6_delay_3;
        end
    end

    // i_notcmp93_atax10(LOGICAL,38)@7
    assign i_notcmp93_atax10_q = redist1_i_exitcond57_atax8_cmp_nsign_q_6_q ^ VCC_q;

    // redist1_i_exitcond57_atax8_cmp_nsign_q_6(DELAY,67)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist1_i_exitcond57_atax8_cmp_nsign_q_6_delay_0 <= '0;
            redist1_i_exitcond57_atax8_cmp_nsign_q_6_delay_1 <= '0;
            redist1_i_exitcond57_atax8_cmp_nsign_q_6_delay_2 <= '0;
            redist1_i_exitcond57_atax8_cmp_nsign_q_6_delay_3 <= '0;
            redist1_i_exitcond57_atax8_cmp_nsign_q_6_q <= '0;
        end
        else
        begin
            redist1_i_exitcond57_atax8_cmp_nsign_q_6_delay_0 <= $unsigned(redist0_i_exitcond57_atax8_cmp_nsign_q_1_q);
            redist1_i_exitcond57_atax8_cmp_nsign_q_6_delay_1 <= redist1_i_exitcond57_atax8_cmp_nsign_q_6_delay_0;
            redist1_i_exitcond57_atax8_cmp_nsign_q_6_delay_2 <= redist1_i_exitcond57_atax8_cmp_nsign_q_6_delay_1;
            redist1_i_exitcond57_atax8_cmp_nsign_q_6_delay_3 <= redist1_i_exitcond57_atax8_cmp_nsign_q_6_delay_2;
            redist1_i_exitcond57_atax8_cmp_nsign_q_6_q <= redist1_i_exitcond57_atax8_cmp_nsign_q_6_delay_3;
        end
    end
    ...
    assign out_c0_exi6178_0_tpl = GND_q;
    assign out_c0_exi6178_1_tpl = redist5_i_idxprom27_atax4_vt_join_q_5_mem_q;
    assign out_c0_exi6178_2_tpl = redist6_i_arrayidx2812_atax5_vt_join_q_5_mem_q;
    assign out_c0_exi6178_3_tpl = i_llvm_fpga_mem_arrayidx28_promoted11_atax6_out_o_readdata;
    assign out_c0_exi6178_4_tpl = redist1_i_exitcond57_atax8_cmp_nsign_q_6_q;
    assign out_c0_exi6178_5_tpl = i_notcmp93_atax10_q;
    assign out_c0_exi6178_6_tpl = redist4_sync_together42_aunroll_x_in_c0_eni1170_1_tpl_6_q;
