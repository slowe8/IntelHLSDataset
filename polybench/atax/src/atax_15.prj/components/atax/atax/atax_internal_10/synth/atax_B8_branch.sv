...
module atax_B8_branch (
    ...
    // out_c0_exe1217(GPOUT,9)
    assign out_c0_exe1217 = in_c0_exe1217;

    // out_c0_exe22032(GPOUT,10)
    assign out_c0_exe22032 = in_c0_exe22032;

    // out_c0_exe72086(GPOUT,11)
    assign out_c0_exe72086 = in_c0_exe72086;

    // out_c0_exe82097(GPOUT,12)
    assign out_c0_exe82097 = in_c0_exe82097;
