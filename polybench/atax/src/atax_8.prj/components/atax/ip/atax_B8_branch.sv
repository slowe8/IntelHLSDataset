...
module atax_B8_branch (
    ...
    // out_c0_exe1194(GPOUT,9)
    assign out_c0_exe1194 = in_c0_exe1194;

    // out_c0_exe21802(GPOUT,10)
    assign out_c0_exe21802 = in_c0_exe21802;

    // out_c0_exe71856(GPOUT,11)
    assign out_c0_exe71856 = in_c0_exe71856;

    // out_c0_exe81867(GPOUT,12)
    assign out_c0_exe81867 = in_c0_exe81867;
