...
module atax_B10_merge (
    ...
    output wire [0:0] out_c0_exe22158,
    output wire [0:0] out_c0_exe42179,
    ...
    // out_c0_exe22158(GPOUT,7)
    assign out_c0_exe22158 = in_c0_exe22158_0;

    // out_c0_exe42179(GPOUT,8)
    assign out_c0_exe42179 = in_c0_exe42179_0;

    // out_c0_exe521810(GPOUT,9)
    assign out_c0_exe521810 = in_c0_exe521810_0;
