...
// SystemVerilog created from atax_i_sfc_logic_s_c0_in_for_inc40_s_c0_enter180_atax0
...
module atax_i_sfc_logic_s_c0_in_for_inc40_s_c0_enter180_atax0 (
    ...
    output wire [0:0] out_c0_exi1183_0_tpl,
    output wire [31:0] out_c0_exi1183_1_tpl,
    ...
    wire [0:0] GND_q;
    wire [0:0] VCC_q;
    wire [31:0] i_llvm_fpga_mem_memdep_14220_atax2_out_memdep_14220_atax_avm_address;
    wire [0:0] i_llvm_fpga_mem_memdep_14220_atax2_out_memdep_14220_atax_avm_burstcount;
    wire [3:0] i_llvm_fpga_mem_memdep_14220_atax2_out_memdep_14220_atax_avm_byteenable;
    wire [0:0] i_llvm_fpga_mem_memdep_14220_atax2_out_memdep_14220_atax_avm_enable;
    wire [0:0] i_llvm_fpga_mem_memdep_14220_atax2_out_memdep_14220_atax_avm_read;
    wire [0:0] i_llvm_fpga_mem_memdep_14220_atax2_out_memdep_14220_atax_avm_write;
    wire [31:0] i_llvm_fpga_mem_memdep_14220_atax2_out_memdep_14220_atax_avm_writedata;
    ...
    reg [31:0] redist0_sync_together10_aunroll_x_in_c0_eni2179_1_tpl_1_q;
    reg [63:0] redist1_sync_together10_aunroll_x_in_c0_eni2179_2_tpl_1_q;
    reg [63:0] redist2_sync_together10_aunroll_x_in_c0_eni2179_2_tpl_2_q;
    ...
    // redist0_sync_together10_aunroll_x_in_c0_eni2179_1_tpl_1(DELAY,17)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist0_sync_together10_aunroll_x_in_c0_eni2179_1_tpl_1_q <= '0;
        end
        else
        begin
            redist0_sync_together10_aunroll_x_in_c0_eni2179_1_tpl_1_q <= $unsigned(in_c0_eni2179_1_tpl);
        end
    end
    ...
    // redist1_sync_together10_aunroll_x_in_c0_eni2179_2_tpl_1(DELAY,18)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist1_sync_together10_aunroll_x_in_c0_eni2179_2_tpl_1_q <= '0;
        end
        else
        begin
            redist1_sync_together10_aunroll_x_in_c0_eni2179_2_tpl_1_q <= $unsigned(in_c0_eni2179_2_tpl);
        end
    end

    // i_llvm_fpga_mem_memdep_14220_atax2(BLACKBOX,6)@1
    ...
    atax_i_llvm_fpga_mem_memdep_14220_0 thei_llvm_fpga_mem_memdep_14220_atax2 (
        .in_flush(in_flush),
        .in_i_address(redist1_sync_together10_aunroll_x_in_c0_eni2179_2_tpl_1_q),
        .in_i_predicate(GND_q),
        .in_i_stall(GND_q),
        .in_i_valid(valid_fanout_reg1_q),
        .in_i_writedata(redist0_sync_together10_aunroll_x_in_c0_eni2179_1_tpl_1_q),
        ...
        .out_memdep_14220_atax_avm_address(i_llvm_fpga_mem_memdep_14220_atax2_out_memdep_14220_atax_avm_address),
        .out_memdep_14220_atax_avm_burstcount(i_llvm_fpga_mem_memdep_14220_atax2_out_memdep_14220_atax_avm_burstcount),
        .out_memdep_14220_atax_avm_byteenable(i_llvm_fpga_mem_memdep_14220_atax2_out_memdep_14220_atax_avm_byteenable),
        .out_memdep_14220_atax_avm_enable(i_llvm_fpga_mem_memdep_14220_atax2_out_memdep_14220_atax_avm_enable),
        .out_memdep_14220_atax_avm_read(i_llvm_fpga_mem_memdep_14220_atax2_out_memdep_14220_atax_avm_read),
        .out_memdep_14220_atax_avm_write(i_llvm_fpga_mem_memdep_14220_atax2_out_memdep_14220_atax_avm_write),
        .out_memdep_14220_atax_avm_writedata(i_llvm_fpga_mem_memdep_14220_atax2_out_memdep_14220_atax_avm_writedata),
        .out_o_stall(),
        .out_o_valid(),
        .out_o_writeack(),
        .clock(clock),
    ...
    assign out_memdep_14220_atax_avm_address = i_llvm_fpga_mem_memdep_14220_atax2_out_memdep_14220_atax_avm_address;
    assign out_memdep_14220_atax_avm_enable = i_llvm_fpga_mem_memdep_14220_atax2_out_memdep_14220_atax_avm_enable;
    assign out_memdep_14220_atax_avm_read = i_llvm_fpga_mem_memdep_14220_atax2_out_memdep_14220_atax_avm_read;
    assign out_memdep_14220_atax_avm_write = i_llvm_fpga_mem_memdep_14220_atax2_out_memdep_14220_atax_avm_write;
    assign out_memdep_14220_atax_avm_writedata = i_llvm_fpga_mem_memdep_14220_atax2_out_memdep_14220_atax_avm_writedata;
    assign out_memdep_14220_atax_avm_byteenable = i_llvm_fpga_mem_memdep_14220_atax2_out_memdep_14220_atax_avm_byteenable;
    assign out_memdep_14220_atax_avm_burstcount = i_llvm_fpga_mem_memdep_14220_atax2_out_memdep_14220_atax_avm_burstcount;
    ...
    // redist2_sync_together10_aunroll_x_in_c0_eni2179_2_tpl_2(DELAY,19)
    always @ (posedge clock or negedge resetn)
    begin
        if (!resetn)
        begin
            redist2_sync_together10_aunroll_x_in_c0_eni2179_2_tpl_2_q <= '0;
        end
        else
        begin
            redist2_sync_together10_aunroll_x_in_c0_eni2179_2_tpl_2_q <= $unsigned(redist1_sync_together10_aunroll_x_in_c0_eni2179_2_tpl_1_q);
        end
    end
    ...
    atax_i_llvm_fpga_mem_unnamed_14_atax0 thei_llvm_fpga_mem_unnamed_atax14_atax3 (
        .in_flush(in_flush),
        .in_i_address(redist2_sync_together10_aunroll_x_in_c0_eni2179_2_tpl_2_q),
        .in_i_predicate(GND_q),
        .in_i_stall(GND_q),
    ...
    assign out_c0_exi1183_0_tpl = GND_q;
    assign out_c0_exi1183_1_tpl = i_llvm_fpga_mem_unnamed_atax14_atax3_out_o_readdata;
