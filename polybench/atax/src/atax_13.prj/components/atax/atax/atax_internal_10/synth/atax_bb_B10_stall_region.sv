...
module atax_bb_B10_stall_region (
    ...
    assign bubble_join_stall_entry_q = {in_c0_exe524110, in_c0_exe42409, in_c0_exe22388};
    ...
    atax_i_llvm_fpga_push_i1_memdep_phi_push20_0 thei_llvm_fpga_push_i1_memdep_phi_push20_atax0 (
        .in_c0_exe42409(bubble_select_stall_entry_c),
    ...
    assign out_c0_exe524110 = bubble_select_stall_entry_d;
