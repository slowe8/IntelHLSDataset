...
// SystemVerilog created from atax_bb_B5_stall_region
...
module atax_bb_B5_stall_region (
    ...
    assign bubble_join_stall_entry_q = in_c0_exe131;

    // bubble_select_stall_entry(BITSELECT,12)
    assign bubble_select_stall_entry_b = $unsigned(bubble_join_stall_entry_q[0:0]);

    // dupName_0_sync_out_x(GPOUT,9)@0
    assign out_c0_exe131 = bubble_select_stall_entry_b;
