...
module atax_B5_branch (
    ...
    // c0_exe131_cmp(LOGICAL,4)
    assign c0_exe131_cmp_q = ~ (in_c0_exe131);

    // valid_out_1_and(LOGICAL,21)
    assign valid_out_1_and_q = in_valid_in & c0_exe131_cmp_q;
    ...
    assign valid_out_0_and_q = in_valid_in & in_c0_exe131;
