...
module atax_bb_B3 (
    ...
    wire [0:0] atax_B3_branch_out_notcmp95;
    wire [0:0] atax_B3_branch_out_stall_out;
    wire [0:0] atax_B3_branch_out_valid_out_0;
    wire [0:0] atax_B3_merge_out_forked104;
    wire [0:0] atax_B3_merge_out_stall_out_0;
    wire [0:0] atax_B3_merge_out_stall_out_1;
    wire [0:0] atax_B3_merge_out_valid_out;
    wire [0:0] bb_atax_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going97_atax0_exiting_stall_out;
    wire [0:0] bb_atax_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going97_atax0_exiting_valid_out;
    wire [63:0] bb_atax_B3_stall_region_out_idxprom;
    wire [31:0] bb_atax_B3_stall_region_out_memdep_15_atax_avm_address;
    wire [0:0] bb_atax_B3_stall_region_out_memdep_15_atax_avm_burstcount;
    wire [15:0] bb_atax_B3_stall_region_out_memdep_15_atax_avm_byteenable;
    wire [0:0] bb_atax_B3_stall_region_out_memdep_15_atax_avm_enable;
    wire [0:0] bb_atax_B3_stall_region_out_memdep_15_atax_avm_read;
    wire [0:0] bb_atax_B3_stall_region_out_memdep_15_atax_avm_write;
    wire [127:0] bb_atax_B3_stall_region_out_memdep_15_atax_avm_writedata;
    wire [31:0] bb_atax_B3_stall_region_out_memdep_16_atax_avm_address;
    wire [0:0] bb_atax_B3_stall_region_out_memdep_16_atax_avm_burstcount;
    wire [3:0] bb_atax_B3_stall_region_out_memdep_16_atax_avm_byteenable;
    wire [0:0] bb_atax_B3_stall_region_out_memdep_16_atax_avm_enable;
    wire [0:0] bb_atax_B3_stall_region_out_memdep_16_atax_avm_read;
    wire [0:0] bb_atax_B3_stall_region_out_memdep_16_atax_avm_write;
    wire [31:0] bb_atax_B3_stall_region_out_memdep_16_atax_avm_writedata;
    ...
    wire [0:0] bb_atax_B3_stall_region_out_notcmp95;
    ...
    atax_B3_merge theatax_B3_merge (
        ...
        .out_forked104(atax_B3_merge_out_forked104),
    ...
    atax_bb_B3_stall_region thebb_atax_B3_stall_region (
        .in_flush(in_flush),
        .in_forked104(atax_B3_merge_out_forked104),
        ...
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going97_atax0_exiting_stall_out(bb_atax_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going97_atax0_exiting_stall_out),
        .out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going97_atax0_exiting_valid_out(bb_atax_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going97_atax0_exiting_valid_out),
        .out_idxprom(bb_atax_B3_stall_region_out_idxprom),
        .out_memdep_15_atax_avm_address(bb_atax_B3_stall_region_out_memdep_15_atax_avm_address),
        .out_memdep_15_atax_avm_burstcount(bb_atax_B3_stall_region_out_memdep_15_atax_avm_burstcount),
        .out_memdep_15_atax_avm_byteenable(bb_atax_B3_stall_region_out_memdep_15_atax_avm_byteenable),
        .out_memdep_15_atax_avm_enable(bb_atax_B3_stall_region_out_memdep_15_atax_avm_enable),
        .out_memdep_15_atax_avm_read(bb_atax_B3_stall_region_out_memdep_15_atax_avm_read),
        .out_memdep_15_atax_avm_write(bb_atax_B3_stall_region_out_memdep_15_atax_avm_write),
        .out_memdep_15_atax_avm_writedata(bb_atax_B3_stall_region_out_memdep_15_atax_avm_writedata),
        .out_memdep_16_atax_avm_address(bb_atax_B3_stall_region_out_memdep_16_atax_avm_address),
        .out_memdep_16_atax_avm_burstcount(bb_atax_B3_stall_region_out_memdep_16_atax_avm_burstcount),
        .out_memdep_16_atax_avm_byteenable(bb_atax_B3_stall_region_out_memdep_16_atax_avm_byteenable),
        .out_memdep_16_atax_avm_enable(bb_atax_B3_stall_region_out_memdep_16_atax_avm_enable),
        .out_memdep_16_atax_avm_read(bb_atax_B3_stall_region_out_memdep_16_atax_avm_read),
        .out_memdep_16_atax_avm_write(bb_atax_B3_stall_region_out_memdep_16_atax_avm_write),
        .out_memdep_16_atax_avm_writedata(bb_atax_B3_stall_region_out_memdep_16_atax_avm_writedata),
        ...
        .out_notcmp95(bb_atax_B3_stall_region_out_notcmp95),
    ...
    assign out_exiting_stall_out = bb_atax_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going97_atax0_exiting_stall_out;

    // out_exiting_valid_out(GPOUT,6)
    assign out_exiting_valid_out = bb_atax_B3_stall_region_out_aclp_to_limiter_i_llvm_fpga_pipeline_keep_going97_atax0_exiting_valid_out;

    // out_idxprom(GPOUT,7)
    assign out_idxprom = atax_B3_branch_out_idxprom;

    // out_memdep_15_atax_avm_address(GPOUT,8)
    assign out_memdep_15_atax_avm_address = bb_atax_B3_stall_region_out_memdep_15_atax_avm_address;

    // out_memdep_15_atax_avm_burstcount(GPOUT,9)
    assign out_memdep_15_atax_avm_burstcount = bb_atax_B3_stall_region_out_memdep_15_atax_avm_burstcount;

    // out_memdep_15_atax_avm_byteenable(GPOUT,10)
    assign out_memdep_15_atax_avm_byteenable = bb_atax_B3_stall_region_out_memdep_15_atax_avm_byteenable;

    // out_memdep_15_atax_avm_enable(GPOUT,11)
    assign out_memdep_15_atax_avm_enable = bb_atax_B3_stall_region_out_memdep_15_atax_avm_enable;

    // out_memdep_15_atax_avm_read(GPOUT,12)
    assign out_memdep_15_atax_avm_read = bb_atax_B3_stall_region_out_memdep_15_atax_avm_read;

    // out_memdep_15_atax_avm_write(GPOUT,13)
    assign out_memdep_15_atax_avm_write = bb_atax_B3_stall_region_out_memdep_15_atax_avm_write;

    // out_memdep_15_atax_avm_writedata(GPOUT,14)
    assign out_memdep_15_atax_avm_writedata = bb_atax_B3_stall_region_out_memdep_15_atax_avm_writedata;

    // out_memdep_16_atax_avm_address(GPOUT,15)
    assign out_memdep_16_atax_avm_address = bb_atax_B3_stall_region_out_memdep_16_atax_avm_address;

    // out_memdep_16_atax_avm_burstcount(GPOUT,16)
    assign out_memdep_16_atax_avm_burstcount = bb_atax_B3_stall_region_out_memdep_16_atax_avm_burstcount;

    // out_memdep_16_atax_avm_byteenable(GPOUT,17)
    assign out_memdep_16_atax_avm_byteenable = bb_atax_B3_stall_region_out_memdep_16_atax_avm_byteenable;

    // out_memdep_16_atax_avm_enable(GPOUT,18)
    assign out_memdep_16_atax_avm_enable = bb_atax_B3_stall_region_out_memdep_16_atax_avm_enable;

    // out_memdep_16_atax_avm_read(GPOUT,19)
    assign out_memdep_16_atax_avm_read = bb_atax_B3_stall_region_out_memdep_16_atax_avm_read;

    // out_memdep_16_atax_avm_write(GPOUT,20)
    assign out_memdep_16_atax_avm_write = bb_atax_B3_stall_region_out_memdep_16_atax_avm_write;

    // out_memdep_16_atax_avm_writedata(GPOUT,21)
    assign out_memdep_16_atax_avm_writedata = bb_atax_B3_stall_region_out_memdep_16_atax_avm_writedata;
    ...
    // out_notcmp95(GPOUT,29)
    assign out_notcmp95 = atax_B3_branch_out_notcmp95;
