// hld_memory_depth_quantization.svh
//
...
`ifndef RAM_QUANTIZATION_SVH
`define RAM_QUANTIZATION_SVH

// Use the full depth available to MLAB or M20K.
function int quantizeRamDepth;
input int depth;
begin
    quantizeRamDepth =
...
function int quantizeRamDepthUsingWidth;
...
function int quantizeFifoDepth;
input int depth;
begin
...
function int quantizeFifoDepthUsingWidth;
input int depth, width;
begin
