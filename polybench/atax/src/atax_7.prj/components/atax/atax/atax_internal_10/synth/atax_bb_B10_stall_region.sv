...
module atax_bb_B10_stall_region (
    ...
    assign bubble_join_stall_entry_q = {in_c0_exe520910, in_c0_exe42089, in_c0_exe22068};
    ...
    atax_i_llvm_fpga_push_i1_memdep_phi_push20_0 thei_llvm_fpga_push_i1_memdep_phi_push20_atax0 (
        .in_c0_exe42089(bubble_select_stall_entry_c),
    ...
    assign out_c0_exe520910 = bubble_select_stall_entry_d;
