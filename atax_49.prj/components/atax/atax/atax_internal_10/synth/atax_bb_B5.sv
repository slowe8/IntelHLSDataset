...
module atax_bb_B5 (
    ...
    wire [0:0] atax_B5_merge_out_almost_empty_out;
    wire [0:0] atax_B5_merge_out_c0_exe51;
    wire [0:0] atax_B5_merge_out_empty_out;
    wire [0:0] atax_B5_merge_out_stall_out_0;
    wire [0:0] atax_B5_merge_out_valid_out;
    wire [0:0] bb_atax_B5_stall_region_out_almost_empty_out;
    wire [0:0] bb_atax_B5_stall_region_out_c0_exe51;
    wire [0:0] bb_atax_B5_stall_region_out_empty_out;
    ...
    atax_B5_branch theatax_B5_branch (
        .in_almost_empty_in(bb_atax_B5_stall_region_out_almost_empty_out),
        .in_c0_exe51(bb_atax_B5_stall_region_out_c0_exe51),
        .in_empty_in(bb_atax_B5_stall_region_out_empty_out),
    ...
    atax_bb_B5_stall_region thebb_atax_B5_stall_region (
        .in_almost_empty_in(atax_B5_merge_out_almost_empty_out),
        .in_c0_exe51(atax_B5_merge_out_c0_exe51),
        .in_empty_in(atax_B5_merge_out_empty_out),
        .in_stall_in(atax_B5_branch_out_stall_out),
        .in_valid_in(atax_B5_merge_out_valid_out),
        .out_almost_empty_out(bb_atax_B5_stall_region_out_almost_empty_out),
        .out_c0_exe51(bb_atax_B5_stall_region_out_c0_exe51),
        .out_empty_out(bb_atax_B5_stall_region_out_empty_out),
    ...
    atax_B5_merge theatax_B5_merge (
        ...
        .out_almost_empty_out(atax_B5_merge_out_almost_empty_out),
        .out_c0_exe51(atax_B5_merge_out_c0_exe51),
        .out_empty_out(atax_B5_merge_out_empty_out),
